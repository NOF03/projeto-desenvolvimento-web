    ...
    return (
        <button>
            <div className='grid items-center text-center h-28 bg-white rounded-full'>
                <span className=' pl-32 pr-2 text-lg md:text-3xl font-bold text-black'>{props.label}</span>
...
function CardScore(props) {
    return (
        <>
            <div {...props} className=" grid py-10 h-full bg-[#343363] w-full rounded-2xl gap-5">
